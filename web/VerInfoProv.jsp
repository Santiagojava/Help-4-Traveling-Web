...
<!DOCTYPE html>
<%
    //HashMap<String,String> provs=(HashMap<String,String>)request.getSession().getAttribute("provs");
%>
<html>
    <head>
            <meta charset="utf-8">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <div class="container">
            <form id="form1" name="form1" method="post" action="VerInfoProvServlet">
                <select name="proveedor" style="color:#000000">
